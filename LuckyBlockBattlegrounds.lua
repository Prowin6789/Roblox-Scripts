--[[
    Скрипт: Premium GUI спавнер блоков для Roblox (МОБИЛЬНАЯ ОПТИМИЗАЦИЯ)
    Версия: 2.6
    Исправления: уменьшен размер UI и кнопки для мобильных устройств
]]
...
-- Определение платформы и размера экрана
...
-- Пульсация (с меньшей амплитудой)
local pulseTween
...
print("✅ Premium Block Spawner v2.6 loaded. Platform: " .. (isMobile and "Mobile (optimized)" or isTablet and "Tablet" or "PC"))